#ifndef INCLUDE_CPU_CPU_OPT6_H
#define INCLUDE_CPU_CPU_OPT6_H
#include "include/GemmFactory.hpp"

template<typename T>
class CpuOpt6 : public GemmBase<T>{
public:
    typedef GemmBase<T> Base;


    CpuOpt6(int warm_up = 0, int iter_num = 1)
