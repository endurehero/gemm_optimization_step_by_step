#ifndef INCLUDE_CPU_CPU_OPT2_H
#define INCLUDE_CPU_CPU_OPT2_H
#include "include/GemmFactory.hpp"

template<typename T>
class CpuOpt2 : public GemmBase<T>{
public:
    typedef GemmBase<T> Base;


    CpuOpt2(int warm_up = 0, int iter_num = 1)
