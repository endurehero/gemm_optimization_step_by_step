#ifndef INCLUDE_CPU_CPU_OPT3_H
#define INCLUDE_CPU_CPU_OPT3_H
#include "include/GemmFactory.hpp"

template<typename T>
class CpuOpt3 : public GemmBase<T>{
public:
    typedef GemmBase<T> Base;


    CpuOpt3(int warm_up = 0, int iter_num = 1)
