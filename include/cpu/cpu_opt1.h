#ifndef INCLUDE_CPU_CPU_OPT1_H
#define INCLUDE_CPU_CPU_OPT1_H
#include "include/GemmFactory.hpp"

template<typename T>
class CpuOpt1 : public GemmBase<T>{
public:
    typedef GemmBase<T> Base;


    CpuOpt1(int warm_up = 0, int iter_num = 1)
